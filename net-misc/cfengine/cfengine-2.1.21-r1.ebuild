...
# $Header: /var/cvsroot/gentoo-x86/net-misc/cfengine/cfengine-2.1.21.ebuild,v 1.1 2006/09/20 22:11:10 ramereth Exp $
...
src_compile() {
	...
	epatch ${FILESDIR}/cfengine-add-gentoo-class.patch
	econf \
