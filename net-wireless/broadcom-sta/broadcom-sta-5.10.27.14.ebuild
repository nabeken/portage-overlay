...
SRC_URI="x86? ( http://www.broadcom.com/docs/linux_sta/hybrid-portsrc-x86_32-v${MY_PV}.tar.gz )
	amd64? ( http://www.broadcom.com/docs/linux_sta/hybrid-portsrc-x86_64-v${MY_PV}.tar.gz )"
