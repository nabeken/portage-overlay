...
SRC_URI="http://archive.apache.org/dist/spamassassin/source/${MY_P}.tar.bz2 mirror://gentoo/${MY_P}.tar.bz2
         http://spamassassin.jp/download/sa3.2/spamassassin-3.2.4-ja-test1.patch"

SRC_TEST="do"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~hppa ~ia64 ~ppc ~ppc64 ~sparc x86"
IUSE="berkdb qmail ssl doc ldap mysql postgres sqlite tools ipv6 cjk"
...
src_compile() {
	...
	if use cjk; then
		epatch ${DISTDIR}/${P}-ja-test1.patch
	fi
